...
class Trials:
    ...
    def save_to_xlsx(self, filename):
        ...
        verification = "=IF(AND(OR(A{0} =\"letters\",A{0} =\"figures\",A{0} =\"NamesHeightRelations\", A{0} =\"NamesAgeRelations\"),OR(B{0} = 2,B{0} = 3,B{0} = 4),OR(D{0} = 0,D{0} = 1),OR(E{0} = 0,E{0} = 1),OR(I{0} = 0,I{0} = 1),OR(K{0} = 0,K{0} = 1),OR(L{0} = 0,L{0} = 1),OR(N{0} = 0,N{0} = 1),OR(O{0} = 0,O{0} = 1)),1, 0)"
        global_verification = "=SUM(Q2: Q500)"
        ...
        ws.append(
            ['SAMPLE_TYPE', 'N', 'NR', 'MEMORY', 'INTEGR', 'SHOW_TIME', 'RESP_TIME', 'MAXTIME', 'FEEDB', 'FEEDB_TIME',
             'WAIT', 'EXP', 'FIXTIME', 'EEG', 'LIST_VIEW', '', global_verification])
        ...
        for idx, trial_info in enumerate(self.list_of_trials):
            ws.append([trial_info['SAMPLE_TYPE'], trial_info['N'], trial_info['NR'], trial_info['MEMORY'],
                       ...
                       trial_info['FIXTIME'], trial_info['EEG'], trial_info['LIST_VIEW'], '' ,verification.format(idx+2)])
